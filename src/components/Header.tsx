...
import { softScale } from "../motion/presets";
    ...
    <header className="site-header">
      ...
      >
        ...
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-md bg-white/10 p-2 text-text transition hover:bg-white/20 lg:hidden"
      ...
      <AnimatePresence>
        {menuOpen ? (
          <div className="lg:hidden">
            ...
            <motion.div
              ref={drawerRef}
              className="fixed right-0 top-0 z-50 h-full w-80 max-w-full bg-bg-dark/95 p-6 shadow-strong backdrop-blur-md"
              role="dialog"
              aria-modal="true"
